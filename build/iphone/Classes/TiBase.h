...
// in simulator we redefine to format for Sample20120419 Developer console
...
{\
	NSString * exceptionName = [@"org.sample20120419." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sample20120419";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UISample20120419NativeItemNone = -1, 
	UISample20120419NativeItemSpinner = -2,
	UISample20120419NativeItemProgressBar = -3,
	
	UISample20120419NativeItemSlider = -4,
	UISample20120419NativeItemSwitch = -5,
	UISample20120419NativeItemMultiButton = -6,
	UISample20120419NativeItemSegmented = -7,
	
	UISample20120419NativeItemTextView = -8,
	UISample20120419NativeItemTextField = -9,
	UISample20120419NativeItemSearchBar = -10,
	
	UISample20120419NativeItemPicker = -11,
	UISample20120419NativeItemDatePicker = -12,
	
	UISample20120419NativeItemInfoLight = -13,
	UISample20120419NativeItemInfoDark = -14,
	
	UISample20120419NativeItemDisclosure = -15,
	
	UISample20120419NativeItemContactAdd = -16
};
