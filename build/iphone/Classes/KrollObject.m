...
//@interface Sample20120419Object : NSObject
//@end

@interface Sample20120419Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Sample20120419Object class]])
		{
			for (NSString *key in [[(Sample20120419Object*)o modules] allKeys])
			{
